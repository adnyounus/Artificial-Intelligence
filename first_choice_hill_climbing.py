# -*- coding: utf-8 -*-
"""First_choice_hill_climbing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uele9di50nk-GGfFxKvF3DzZhreu9Bya
"""
  ...
  while ( i < len1):
    ...
    while ( j < len1):
      ...
      if new_cost < current_state_cost:
        current_state_cost = new_cost
        current_state = deepcopy(c_state)
      c_state = deepcopy(current_state)
      j = j + 1

    i = i + 1

  main_cost = current_state_cost
